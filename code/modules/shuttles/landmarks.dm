...
/obj/effect/shuttle_landmark/LateInitialize()
	...
	if(GLOB.using_map.use_overmap)
		var/obj/effect/overmap/visitable/location = SSmapping.map_sectors["[z]"]
		if(location && location.docking_codes)
			docking_controller.docking_codes = location.docking_codes

/obj/effect/shuttle_landmark/forceMove()
	var/obj/effect/overmap/visitable/map_origin = SSmapping.map_sectors["[z]"]
	. = ..()
	var/obj/effect/overmap/visitable/map_destination = SSmapping.map_sectors["[z]"]
